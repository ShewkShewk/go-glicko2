...
func (rating Rating) Phi() float64 {
	return rating.phi
}
...
func (rating *Rating) SetR(r float64) {
	setR(rating, r)
}

func (rating *Rating) SetMu(mu float64) {
	setMu(rating, mu)
}

func (rating *Rating) SetRd(rd float64) {
	setRd(rating, rd)
}

func (rating *Rating) SetPhi(phi float64) {
	setPhi(rating, phi)
}

func (rating *Rating) SetSigma(sigma float64) {
